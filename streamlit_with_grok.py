...
# Function to generate SQL query using xAI API (Grok 3)
def generate_sql_query(natural_language: str) -> str:
    ...
    try:
        response = requests.post("https://api.x.ai/v1/completions", json=payload, headers=headers)
    ...
    try:
        async def process_command(command):
            async with client:
                ...
                # Handle run_sql_query (NLP or direct)
                ...
                # Handle NLP for SQL query
                    ...
                    # Assume natural language input is for SQL query
